    ...
    <section id="contact" className="py-12 sm:py-20 px-4  scroll-mt-20">
      <div className="max-w-4xl mx-auto text-center px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-white text-center">
          <div className="border border-gray-800 p-4 rounded-2xl hover:scale-105 transition-all">
            <Mail className="mx-auto mb-2 text-gray-400" size={32} />
            <p className="font-semibold">Email</p>
            <p className="text-sm">haroonkhanlala47@gmail.com</p>
          </div>

          <div className="border border-gray-800 p-4 rounded-2xl hover:scale-105 transition-all">
            <Phone className="mx-auto mb-2 text-gray-400" size={32} />
            <p className="font-semibold">Phone/Whatsapp</p>
            <p className="text-sm">+92 3340520574</p>
          </div>

          <div className="border border-gray-800 p-4 rounded-2xl hover:scale-105 transition-all">
            <MapPin className="mx-auto mb-2 text-gray-400" size={32} />
            <p className="font-semibold">Location</p>
            <p className="text-sm">Lund Khwar, Mardan, pk</p>
          </div>
        </div>
